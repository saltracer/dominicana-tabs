      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={styles.form}>
          ...
          <View style={styles.field}>
            ...
            {uploadProgress.cover !== undefined && (
              <View style={styles.progressContainer}>
                <View style={[styles.progressBar, { width: `${uploadProgress.cover}%`, backgroundColor: Colors[colorScheme ?? 'light'].primary }]} />
              </View>
            )}
          </View>
          ...
          <View style={styles.field}>
            ...
            {book?.epubPath ? (
              <View style={[styles.fileInfo, { backgroundColor: Colors[colorScheme ?? 'light'].card }]}>
            ...
            {uploadProgress.epub !== undefined && (
              <View style={styles.progressContainer}>
                <View style={[styles.progressBar, { width: `${uploadProgress.epub}%`, backgroundColor: Colors[colorScheme ?? 'light'].primary }]} />
              </View>
            )}
          </View>
          ...
          <View style={styles.field}>
            ...
            {uploadProgress.epubSample !== undefined && (
              <View style={styles.progressContainer}>
                <View style={[styles.progressBar, { width: `${uploadProgress.epubSample}%`, backgroundColor: Colors[colorScheme ?? 'light'].primary }]} />
              </View>
            )}
          </View>
        </View>
