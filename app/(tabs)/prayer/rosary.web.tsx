...
export default function RosaryWebScreen() {
  ...
  useEffect(() => {
    ...
    console.log('[Rosary Audio Web] Playing:', audioFile, 'Voice:', rosaryVoice);
    
    // Auto-advance callback
    const onComplete = () => {
      console.log('[Rosary Audio Web] Prayer complete');
    ...
    if (currentBead.id === 'opening-hail-mary-faith') {
      console.log('[Rosary Audio Web] Playing Faith, Hope, Charity sequence');
    ...
    if (shouldPlayAlleluia) {
      console.log('[Rosary Audio Web] Playing Glory Be + Alleluia sequence');
      rosaryAudio.playSequence([
