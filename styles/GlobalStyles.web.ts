...
import { containerMaxWidths } from '@/constants/Breakpoints';
 ...
 * 
 * Enhanced with responsive utilities for the web redesign.
 */
...
export const GlobalStyles = StyleSheet.create({
  ...
  // =============================================================================
  // HOVER & INTERACTION STATES (WEB)
  // =============================================================================
  
  // Card hover effects
  cardHover: {
    // Applied via style prop with hover state
